...
const FacultyLogin = () => {
  ...
  return (
    ...
    >
      {isSignup ? (
        <FacultySignup /> // Render FacultySignup component if isSignup is true
      ) : (
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            >
              <div className="mb-4">
                <label htmlFor="f_email" className="block text-sm font-medium text-gray-700 mb-1">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-1">
                  <label htmlFor="f_password" className="block text-sm font-medium text-gray-700">
                    Password
                  </label>
                  <a 
                    href="#" 
